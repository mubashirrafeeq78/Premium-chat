...
class _ProfileSetupScreenState extends State<ProfileSetupScreen> {
  ...
  // ڈیٹا ویلیڈیشن
  bool _isFormValid() {
    bool baseValid = _nameController.text.length > 2 &&
        _profilePic != null &&
        _selectedRole != null &&
  ...
  Future<void> _handleRegister() async {
    ...
    try {
      ...
      if (response['status'] == 'success') {
        // لوکل اسٹوریج میں ڈیٹا سیو کرنا (Auto-Login کے لیے)
        ...
        // ڈیش بورڈ یا سیکیورٹی گیٹ وے پر بھیجنا
          ...
          child: SingleChildScrollView(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.05), blurRadius: 50)],
              ),
              child: Column(
                children: [
                    ...
                    child: Stack(
                      children: [
                        ...
                        Positioned(
                          bottom: 0, right: 0,
                          child: CircleAvatar(
                            radius: 18, backgroundColor: Color(0xFF3B4CA8),
                  ...
                  Row(
                    children: [
                      _roleBtn("🛠️", "Provider", "provider"),
                      SizedBox(width: 15),
                      _roleBtn("🤝", "Buyer", "buyer"),
                    ],
                  ),

                  if (_selectedRole == 'provider') ...[
                    SizedBox(height: 25),
                    _uploadBox("CNIC FRONT", _cnicFront, () => _pickImage('front')),
                    _uploadBox("CNIC BACK", _cnicBack, () => _pickImage('back')),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: _isLoading 
                        ...
                        : Text("GO TO APPLICATION", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                    ),
                  )
                ],
              ),
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isActive ? Color(0xFFF0F4FF) : Colors.grey[50],
            borderRadius: BorderRadius.circular(20),
            border: Border.all(color: isActive ? Color(0xFF3B4CA8) : Colors.transparent, width: 2),
          ),
          child: Column(
            children: [
      ...
      child: Container(
        ...
        child: file == null ? Column(
          ...
          children: [
            ...
            Text(label, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Colors.grey)),
          ],
        ) : null,
      ),
    );
